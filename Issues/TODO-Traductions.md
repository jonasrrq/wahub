...
#### src/WaHub/Components/Pages/Admin/Instances.razor
...
- [x] "Logout"
- [x] "Cambiar Avatar"
- [x] "Insignia Verificada"
- [x] "Información Personal (pestaña)"
- [x] "Seguridad (pestaña)"
- [x] "Preferencias (pestaña)"
- [x] "Facturación (pestaña)"
- [x] "Título de Información Personal"
- [x] "Etiqueta Nombre"
- [x] "Etiqueta Apellido"
- [x] "Etiqueta Email"
- [x] "Info de cambio de Email"
- [x] "Etiqueta Teléfono"
- [x] "Etiqueta Empresa"
- [x] "Etiqueta Biografía"
- [x] "Guardando..."
- [x] "Guardar Cambios"
- [x] "Título de Seguridad"
- [x] "Título Cambiar Contraseña"
- [x] "Etiqueta Contraseña Actual"
- [x] "Etiqueta Nueva Contraseña"
- [x] "Etiqueta Confirmar Nueva Contraseña"
- [x] "Botón Cambiar Contraseña"
- [x] "Título Autenticación de Dos Factores"
- [x] "2FA Activado"
- [x] "2FA Desactivado"
- [x] "Descripción 2FA"
- [x] "Desactivar 2FA"
- [x] "Activar 2FA"
- [x] "Título Sesiones Activas"
- [x] "Sesión Actual (insignia)"
- [x] "Cerrar Sesión (botón)"
- [x] "Título de Preferencias"
- [x] "Título Apariencia"
- [x] "Título Tema"
- [x] "Descripción Tema"
- [x] "Tema Claro"
...
- [x] "Tema Auto"
- [x] "Título Idioma"
- [x] "Descripción Idioma"
- [x] "Idioma Español"
- [x] "Idioma Inglés"
- [x] "Idioma Portugés"
- [x] "Título Notificaciones"
- [x] "Título Notificaciones por Email"
- [x] "Descripción Notificaciones por Email"
- [x] "Título Notificaciones Push"
- [x] "Descripción Notificaciones Push"
- [x] "Título Boletín"
- [x] "Descripción Boletín"
- [x] "Botón Guardar Preferencias"
- [x] "Título Facturación"
- [x] "Título Plan Actual"
- [x] "Etiqueta Próxima Facturación"
- [x] "Botón Cambiar Plan"
- [x] "Título Método de Pago"
- [x] "Botón Actualizar Método de Pago"
- [x] "Título Historial de Facturación"
- [x] "Botón Descargar Factura"
- [x] "Confirmar Eliminar Cuenta (título)"
- [x] "Advertencia Eliminar Cuenta"
- [x] "Botón Eliminar Cuenta"

#### src/WaHub.Client/Pages/Dashboard.razor
- [x] "Dashboard"
- [x] "Bienvenido a tu panel de control de WaHub."
- [x] "Instancias Activas"
- [x] "Esta Semana"
- [x] "Mensajes Enviados"
- [x] "vs. Mes Anterior"
- [x] "Contactos"
...
- [x] "vs. Ayer"
- [x] "Mensajes por Día"
- [x] "Gráfico de mensajes aquí..."
- [x] "Actividad Reciente"
- [x] "Mensaje enviado a"
- [x] "hace {0} minutos"
- [x] "Nueva instancia creada: {0}"
- [x] "hace {0} hora"
- [x] "Webhook configurado"
- [x] "hace {0} horas"
- [x] "Contacto añadido: {0}"
- [x] "Acciones Rápidas"
- [x] "Nueva Instancia"
- [x] "Enviar Mensaje"
- [x] "Ver Docs API"
- [x] "Soporte"
- [x] "Prueba de Interactividad"
- [x] "Este es un componente interactivo de prueba. Haz clic en el botón para ver los cambios."
- [x] "Probar Interactividad"
- [x] "Clics"
- [x] "Reiniciar Contador"
- [x] "¡Interacción exitosa!"
- [x] "Monitor de Estado en Tiempo Real"
- [x] "Datos en tiempo real sobre el rendimiento de tu plataforma."
- [x] "Usuarios Online"
- [x] "Mensajes por Segundo"
- [x] "Carga del Servidor"
- [x] "Cola de Mensajes"
- [x] "Pausar"
- [x] "Iniciar"
- [x] "Monitoreo activo."
- [x] "Acceso Denegado"
- [x] "Necesitas iniciar sesión para ver esta página."
- [x] "Ir al inicio de sesión"
